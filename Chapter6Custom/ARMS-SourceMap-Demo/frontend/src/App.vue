...
<template>
  <div style="padding:24px;font-family:Arial;">
    ...
    <button @click="callApi">Call /api/hello</button>
    <br /><br />

    <button @click="throwJsError">
      1️Throw JS Error（SourceMap）
    </button>
    <br /><br />

    <button @click="sendBizException">
      2️sendException（业务异常）
    </button>
    <br /><br />

    <button @click="sendBizCustomEvent">
      3️sendCustom（自定义事件）
    </button>

    <pre
        style="margin-top:16px;background:#111;color:#0f0;padding:12px;border-radius:8px;"
    >
{{ result }}
    </pre>
  </div>
